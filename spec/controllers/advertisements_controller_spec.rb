...
RSpec.describe AdvertisementsController, type: :controller do
  ...
  describe "GET #index" do
    ...
    it "assigns [my_advertisement] to @advertisement" do
      get :index
  #because we created one posts (my_advertisement), we expect index to return an array of one item
  ...
  it "increases the number of Advertisement by 1" do
    expect{ post :create, params: { advertisement: { title: RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.random_price } } }.to change(Advertisement,:count).by(1)
  end
